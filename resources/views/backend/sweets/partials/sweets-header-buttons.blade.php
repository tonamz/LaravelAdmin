<!--Action Button-->
@if( Active::checkUriPattern( 'admin/sweets' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <li>
            <a href="{{ route( 'admin.sweets.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.sweets.all' ) }}
            </a>
        </li>
        @permission( 'create-sweet' )
            <li>
                <a href="{{ route( 'admin.sweets.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.sweets.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
